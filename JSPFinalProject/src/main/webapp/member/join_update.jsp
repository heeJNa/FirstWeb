...
<div class="wrapper row3">
	  ...
	  <div class="wrapper row3">
	     ...
	     <form method="post" action="../member/join_update_ok.do" name="join_frm" id="join_update_frm">
	     	<table class="table">
	     		<tr>
	     		...
	     		<tr>
	     			<td colspan="2" class="text-center">
	     				<input type=button class="btn btn-sm btn-primary" value="수정" id="joinUpdateBtn">
